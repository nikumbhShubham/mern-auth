  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form className=' flex flex-col gap-4' onSubmit={handleSubmit} >
        ...
        <input defaultValue={currentUser.username} type="text" name="username" id="username" placeholder='Username' className='bg-slate-100 rounded-lg p-3' onChange={handleChange} />
        ...
        <input type="text" name="password" id="passwprd" placeholder='password' className='bg-slate-100 rounded-lg p-3' onChange={handleChange} />
